...
if [ -z "$1" ]; then
    ...
    hostname -I && fping -c 5 -I $2 172.27.0.0 172.27.0.1 172.27.0.2 172.27.0.3 172.27.0.4 172.27.0.5 -q
else
#   echo "Running fping for $1 iterations"
    hostname -I && fping -c $1 -I $2 172.27.0.0 172.27.0.1 172.27.0.2 172.27.0.3 172.27.0.4 172.27.0.5 -q
fi
